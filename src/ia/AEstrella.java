...
public class AEstrella extends PApplet {
	...
	boolean equals(Mosaico m){
	    return renglon==m.renglon&&columna==m.columna;
	}
    ...
    class Algoritmo {
		...
		if(actual.estado.padre!=null){
		    listaCerrada.put(actual.estado,actual.estado.padre);
		    actual.estado.padre.situacion= Situacion.EN_LISTA_CERRADA;
		}
		actual.estado.situacion = Situacion.ACTUAL;
		Mosaico tmp = actual.estado;
		if(tmp.equals(estadoFinal)){
